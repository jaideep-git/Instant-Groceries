...
class EasyGroceries {
	...
	public function convertFancyQuotes ($str) {
        return str_replace(array(chr(145),chr(146),chr(147),chr(148),chr(151),chr(150)),array("'","'",'"','"','-','-'),$str);
    }
  ...
  return $data;
    ...
    public function makePayment () {
        ...
        // library has id, username, password
    ...
    public function makeInvoice ($myOrder) {

        $myOrder = json_decode($myOrder,true);
        
        $transaction_code = $myOrder["transaction_code"];
        $ea_user_id = $myOrder["ea_user_id"];
        $email = $myOrder["email"];
        $billing_name_last = $myOrder["billing_name_last"];
        $billing_name_first = $myOrder["billing_name_first"];
        $billing_address = $myOrder["billing_address"];
        $billing_city = $myOrder["billing_city"];
        $billing_province = $myOrder["billing_province"];
        $billing_postal_code = $myOrder["billing_postal_code"];
        $billing_phone = $myOrder["billing_phone"];

        $shipping_name_last = $myOrder["shipping_name_last"];
        $shipping_name_first = $myOrder["shipping_name_first"];
        $shipping_address = $myOrder["shipping_address"];
        $shipping_city = $myOrder["shipping_city"];
        $shipping_province = $myOrder["shipping_province"];
        $shipping_postal_code = $myOrder["shipping_postal_code"];
        $sub_total = $myOrder["sub_total"];
        $total = $myOrder["total"];
        $hst = $myOrder["hst"];
        ...
        */
        ...
        $cart[0] = 23;
        $cart[11] = 55;
        $cart[33] = 244; length = 3

        $cart["email"] = 23;
        $cart[55] = 244;
        $cart["name-last"] = 55;
        $cart[0] = 244;
        $cart["name-first"] = 244; length = 5
